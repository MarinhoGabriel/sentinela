...
def export_gif(target_folder):
    # After creating the sequence from the input files, this function is 
    # responsible for converting the target files into a GIF for a better 
    # visualization of the results.
    images = []
    image_files = get_img_files(target_folder)
